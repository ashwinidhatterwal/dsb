(() => {
  ...
  el('deleteSaved').onclick = () => { if(confirm(t('deleteConfirm')))run(el('deleteSaved'),async()=>{await account.request('customer.saved.delete',{confirm:'DELETE_SAVED_DETAILS'});account.clearPrivate();await showMember(account.user);message(t('deleted'));}); };
