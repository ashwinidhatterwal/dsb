...
assert(!switchTab.includes('scrollTo'), 'Switching admin sections must not force-scroll the page');
...
console.log('PASS: analytics mobile clearance, icon product actions, and stable section switching.');
