...
for (const feature of ['Rotate left', 'Rotate right', '3:4', '4:3', 'Apply edit', 'Focus zoom', 'cropAtZoom', "dragMode = ratio && crop ? 'move' : 'select'", 'formatBytes', 'createImageBitmap']) {
...
if (!css.includes('.image-editor-focus')) fail('focus crop control styling is missing');
if (!css.includes('touch-action:none')) fail('touch crop interaction is missing');
