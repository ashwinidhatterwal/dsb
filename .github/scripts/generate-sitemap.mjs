...
async function main() {
  ...
  const allowed=['id','name','namehindi','category','subcategory','price','mrp','image','images','description','stock','stockqty','tags','sizeprices','brand','material','packsize','specifications','gtin','descriptionhindi','reellink','sizestock','sizes'];
