...
export async function generateStaticProducts(destination,rows,template,site){
 ...
 const catalogList={'@context':'https://schema.org','@type':'ItemList',name:'Dhatterwal Suhag Bhandar product catalogue',numberOfItems:products.length,itemListElement:products.map((p,i)=>({'@type':'ListItem',position:i+1,url:site+'/'+productPath(p.id)}))};
